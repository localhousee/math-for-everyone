...
it("Will generate whole number until 50", () => {
    let { question, answer } = introductionToWholeNumberUntil50();
...
it("Will generate addition and subtraction of whole number until 20", () => {
    let { question, answer } = additionAndSubtractionOfWholeNumberUntil20();
...
it("Will generate image of 2D or 3D shapes", () => {
    let { question, answer } = introductionTo2D3D();
...
it("Will generate image of 2D or 3D shapes", () => {
    let { question, answer } = comparingLengthWeightAndTime();
